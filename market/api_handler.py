...
class APIHandler:
    ...
    async def login(self):
        ...
        response_loginPage = self.session.get(self.trade_url, headers=headers)
    ...
    async def buy_item(self, buyList):
        ...
        for item in buyList:
            ...
            while i < int(item[1]):
                ...
                await asyncio.sleep(random.uniform(1, 2.5))  # Sleep for 1 - 2.5 second between each buy to avoid getting rate limited.
